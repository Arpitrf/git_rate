...
data_temp = np.loadtxt("./dataset/matlabdata2.txt",dtype=np.str,delimiter=",")
data = data_temp[::,1:7]
...
test = [['0','0','0','0','0','0'],['20','82','520','190','400','11'],['167','41','10','123','20','5'],['12','3867','549','554','6745','262'],['1250','600','500','2000','50','50']]
